 ...
 */
public class CancelContractClaimPacket extends Packet {

    private String contractUID;

    public CancelContractClaimPacket() {}

    public CancelContractClaimPacket(String contractUID) {
    ...
    public void processPacketOnServer(PlayerState playerState) {
        ServerDataManager.cancelClaim(playerState, contractUID);
    }
}
