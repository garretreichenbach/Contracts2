...
public class EventManager {
	...
	public static void initialize(Contracts instance) {
		StarLoader.registerListener(PlayerDeathEvent.class, event -> {
		...
		StarLoader.registerListener(GUITopBarCreateEvent.class, event -> {
		...
		StarLoader.registerListener(MainWindowTabAddEvent.class,
				event -> GUIManager.getInstance().createContractsShopTab(event), instance);
	}
}
