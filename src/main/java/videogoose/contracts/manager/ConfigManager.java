...
public final class ConfigManager {
	...
	public static void initialize(Contracts instance) {
		...
		escortBaseReward = new SimpleConfigInt(config, "escort_base_reward", 10000000, "Base reward for escort contracts before difficulty scaling.");
	...
	public static long getEscortBaseReward() {
		return intOrDefault(escortBaseReward, 10000000);
	}
